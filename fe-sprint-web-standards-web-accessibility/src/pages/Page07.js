    ...
    return (
        <article>
            ...
            <section>
                ...
                <div className="inputContainer">
                    {/* 레이블 연결했을때 레이블만 클릭해도 인풋요소에 포커스가 된다! */}
                    <label for="아이디"><span>아이디</span></label>
                    <input id="아이디" type="text" />
                    <label for="비밀번호"><span>비밀번호</span></label>
