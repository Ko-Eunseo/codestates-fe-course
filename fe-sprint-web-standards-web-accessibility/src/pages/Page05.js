            ...
            <section>
                ...
                <section>
                    ...
                    <li>요소의 이름이 요소의 역할을 충분히 설명하지 못할 때 사용할 수 있습니다.
                        <div className="button" role="button">요소는 div</div>
                    </li>
                    ...
                    <div class="tabContainer">
                        ...
                        <div role="tabpannel" className={currentTab === 0 ? "block" : "none"}>{tab.tab1.content.map((el, idx) => <li key={idx}>{el}</li>)}</div>
                        <div role="tabpannel" className={currentTab === 1 ? "block" : "none"}>{tab.tab2.content.map((el, idx) => <li key={idx}>{el}</li>)}</div>
                        <div role="tabpannel" className={currentTab === 2 ? "block" : "none"}>{tab.tab3.content.map((el, idx) => <li key={idx}>{el}</li>)}</div>
                    </div>
                </section>
                <section>
                    ...
                    <div className="iconButtonContainer">
                        ...
                        <button aria-label="인터넷" className="iconButton"><img src={web} /></button>
                        <button aria-label="메일" className="iconButton"><img src={mail} /></button>
                    </div>
                </section>
